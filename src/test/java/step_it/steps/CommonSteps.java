...
import org.step_it.pages.LoginPage;
import org.step_it.pages.MainPage;
...
public class CommonSteps {
    ...
    private void checkCartCounter(int counter, String assertionMassage) {
        assertThat(mainPage.GetProductCountInCart()).as(assertionMassage).isEqualTo(counter);
